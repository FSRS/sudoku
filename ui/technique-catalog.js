(function (root) {
  ...
  const definitions = [
    ...
    ["ui_UR", "combinedUniqueRectangle", null, 4, 100, true, ["ui_AR"]],
    ["ui_BUG_plus_n", "bugPlusN", null, 5, 110],
    ["ui_HR", "combinedHiddenRectangle", null, 5, 110, true, ["ui_UR_type_7"]],
    [
      "ui_UET",
    ...
    ["ui_UL", "combinedUniqueLoop", null, 5, 120, true, ["ui_AUL"]],
    ["ui_EUR", "combinedExtendedRectangle", null, 5, 140, true, ["ui_AEUR"]],
    ...
    [
      ...
      350,
      true,
      ["ui_cell_DB", "ui_region_DB", "ui_AALS_DB"],
    ],
    [
      "ui_complex_swordfish",
      "complexFish",
      3,
      10,
      360,
      true,
      ["ui_finned_franken_swordfish", "ui_finned_mutant_swordfish"],
    ],
    [
      "ui_complex_jellyfish",
      "complexFish",
      4,
      10,
      380,
      true,
      ["ui_finned_franken_jellyfish", "ui_finned_mutant_jellyfish"],
    ],
    [
      "ui_complex_squirmbag",
      "complexFish",
      5,
      10,
      400,
      true,
      ["ui_finned_franken_squirmbag", "ui_finned_mutant_squirmbag"],
    ],
    [
      "ui_BLo",
      "blossomLoop",
      ...
      400,
      true,
      ["ui_cell_BLo", "ui_region_BLo", "ui_AALS_BLo"],
    ],
    ...
    [
      ...
      450,
      true,
      ["ui_cell_AAIC", "ui_region_AAIC", "ui_AALS_AAIC"],
    ],
