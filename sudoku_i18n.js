...
const TRANSLATIONS = {
  en: {
    ...
    ui_load_completed_in_ms: "Load completed in {0} ms",
    ui_BUG_plus_1: "BUG+1",
    ...
    ui_AHS_XZ: "Almost Hidden Set XZ-Rule",
    ui_AHS_XY_Wing: "Almost Hidden Set XY-Wing",
    ui_AHS_W_Wing: "Almost Hidden Set W-Wing",
    ui_AHS_AIC: "Almost Hidden Set AIC",
    ...
    teks_X_Wing: "X-Wing",
    teks_swordfish: "Swordfish",
    teks_jellyfish: "Jellyfish",
    ...
    teks_firework_quadruple: "Firework Quadruple",
    teks_firework_digits: "Digits ({0})",
    teks_firework_quadruple_digits: "Digits ({0}) and ({1})",
    ...
    teks_AHS_XZ: "Almost Hidden Set XZ-Rule",
    teks_AHS_XY_Wing: "Almost Hidden Set XY-Wing",
    teks_AHS_W_Wing: "Almost Hidden Set W-Wing",
    teks_AHS_AIC: "Almost Hidden Set AIC",
  ...
  ko: {
    ...
    ui_load_completed_in_ms: "퍼즐 로드 완료까지 걸린 시간: {0} ms",
    ui_BUG_plus_1: "BUG+1",
    ui_UR: "유일한 직사각형",
    ui_UL: "유일한 고리",
    ...
    ui_AHS_XZ: "거의 숨은 집합 XZ",
    ui_AHS_XY_Wing: "거의 숨은 집합 XY-윙",
    ui_AHS_W_Wing: "거의 숨은 집합 W-윙",
    ui_AHS_AIC: "거의 숨은 집합 교대 추론 사슬",
    ui_NakedS: "드러난 하나",
    ui_HiddenS: "숨은 하나",
    ui_HiddenT: "숨은 셋",
    ui_NakedQ: "드러난 넷",
    ...
    teks_firework_quadruple_digits: "숫자 ({0}) 및 ({1})",
    teks_firework_position: "({0})r{1}c{2}b{3}",
    teks_firework_quadruple_position: "({0})r{1}c{2}b{3}, ({4})r{5}c{6}b{7}",
    ...
    teks_AHS_XZ: "거의 숨은 집합 XZ",
    teks_AHS_XY_Wing: "거의 숨은 집합 XY-윙",
    teks_AHS_W_Wing: "거의 숨은 집합 W-윙",
    teks_AHS_AIC: "거의 숨은 집합 교대 추론 사슬",
