...
const TRANSLATIONS = {
  ...
  ko: {
    ...
    teks_FH_box: "{0}번 상자",
    teks_unit_box: "상자",
    teks_last_digit_in_at: "{1}에서 {2}에 남은 마지막 숫자 ({0})",
    teks_FH: "가득찬 집",
    teks_NakedS: "드러난 하나",
    ...
    teks_together_have_digits_on_intersection_of_and_box:
      "{3}번 {2}과(와) {4}번 상자의 교차로에 있는 {0}에 숫자 ({1})만 들어갈 수 있음",
