...
const TRANSLATIONS = {
  en: {
    ...
    ui_msg_166: "Unmeasured: Level 12",
    ...
    ui_msg_340: "Cell Blossom Loop",
    ui_msg_341: "Region Blossom Loop",
    ui_msg_342: "AALS Blossom Loop",
    ui_msg_343: "AALS Death Blossom",
    ui_msg_344: "Avoidable Rectangle",
    ui_msg_345: "Uniqueness External Test",
    ui_msg_346: "Finned Franken Jellyfish",
    ui_msg_347: "Finned Mutant Jellyfish",
    ui_msg_348: "Cell Almost AIC",
    ui_msg_349: "Region Almost AIC",
    ui_msg_350: "AALS Almost AIC",
    ui_msg_351: "Death Blossom",
    ...
    teks_msg_101: "Extended Unique Rectangle Type 5",
    ...
    teks_msg_193: "Cell Blossom Loop",
    teks_msg_194: "Region Blossom Loop",
    teks_msg_195: "Burr on {0}",
    ...
    teks_msg_323: "Gurth's Symmetrical Placement",
    teks_msg_324: "Puzzle is diagonally symmetric in the {0} direction",
    teks_msg_325: "Puzzle is centrally symmetric",
    teks_msg_326: "top-left",
    teks_msg_327: "top-right",
    teks_msg_328: "Candidate's mapping in {0}: {1}",
    teks_msg_329: "Diagonal",
    teks_msg_330: "Antidiagonal",
    teks_msg_331: "X-Axis",
    teks_msg_332: "Y-Axis",
    teks_msg_333: "Central",
  ...
  ko: {
    ...
    ui_msg_122: "팁: 셀을 터치한 후 숫자를 눌러 후보숫자를 적거나 지웁니다.",
    ui_msg_123: "팁: 셀을 클릭한 후 숫자를 눌러 후보숫자를 적거나 지웁니다.",
    ...
    ui_msg_341: "고리꽃 (영역)",
    ui_msg_342: "고리꽃 (AALS)",
    ui_msg_343: "죽음의 꽃 (AALS)",
    ui_msg_344: "회피 가능한 직사각형",
    ui_msg_345: "외부 수호자 논법",
    ui_msg_346: "지느러미 달린 조작된 해파리",
    ui_msg_347: "지느러미 달린 변이된 해파리",
    ui_msg_348: "거의 완성된 교대 추론 사슬 (칸)",
    ui_msg_349: "거의 완성된 교대 추론 사슬 (영역)",
    ui_msg_350: "거의 완성된 교대 추론 사슬 (AALS)",
    ui_msg_351: "죽음의 꽃",
    ui_msg_352: "고리꽃",
    ...
    teks_msg_76: "유일한 직사각형 유형 1",
    teks_msg_77: "숫자 ({0}{1}) 사용",
    teks_msg_78: "({2})의 기반 숫자 ({0}{1}), 수호자 {3}",
    teks_msg_79: "유일한 직사각형 유형 2",
    teks_msg_80: "유일한 직사각형 유형 5",
    teks_msg_83: "유일한 직사각형 유형 3",
    teks_msg_85:
      "{2}의 기반 숫자 ({0}{1}), 수호자 {3}, 가상의 드러난 부분집합을 위한 추가 칸 {4}",
    teks_msg_86: "{0}번 행",
    teks_msg_87: "{0}번 열",
    teks_msg_88: "유일한 직사각형 유형 4",
    teks_msg_90:
      "{2}의 기반 숫자 ({0}{1}), 수호자 {3}, {5}에서 수호자와 기반 숫자 ({4}) 제한됨",
    teks_msg_91: "유일한 직사각형 유형 6",
    teks_msg_93:
    ...
    teks_msg_98: "확장된 유일한 직사각형 유형 1",
    teks_msg_99: "숫자 ({0}) 사용",
    teks_msg_100: "확장된 유일한 직사각형 유형 2",
    teks_msg_101: "확장된 유일한 직사각형 유형 5",
    teks_msg_102: "확장된 유일한 직사각형 유형 3",
    teks_msg_104: "{0}, 가상의 드러난 부분집합을 위한 추가 칸 {1}",
    teks_msg_105: "확장된 유일한 직사각형 유형 4",
    teks_msg_107: "{0}, {2}에서 기반 숫자 ({1}) 제한됨",
    teks_msg_108: "확장된 유일한 직사각형 유형 6",
    teks_msg_110:
      "{0}, 모든 수호자를 제거하는 직사각형 위의 숫자 ({1})의 배치를 제외",
    teks_msg_111: "({1})의 기반 숫자 ({0}), 수호자 {2}",
    teks_msg_112: "유일한 고리 유형 1",
    teks_msg_113: "숫자 ({0}) 사용",
    teks_msg_114: "유일한 고리 유형 2",
    teks_msg_115: "유일한 고리 유형 5",
    teks_msg_117: "유일한 고리 유형 3",
    teks_msg_119: "{0}, 가상의 드러난 부분집합을 위한 추가 칸 {1}",
    teks_msg_120: "유일한 고리 유형 4",
    teks_msg_121: "유일한 고리 유형 6",
    teks_msg_122:
    ...
    teks_msg_173: "r{0}c{1}내 모든 후보숫자가 색 {2}과(와) NAND 관계에 있음.",
    teks_msg_174: "{0}번 행",
    teks_msg_175: "{0}번 열",
    teks_msg_176: "{0}번 상자",
    teks_msg_177:
    ...
    teks_msg_322: "수호자 {0}",
    teks_msg_323: "거스의 대칭 배치",
    teks_msg_324: "{0} 방향으로 대각선 대칭인 퍼즐",
    teks_msg_325: "중심점을 기준으로 점대칭인 퍼즐",
    teks_msg_326: "좌상향",
    teks_msg_327: "우상향",
    teks_msg_328: "후보숫자들이 {0}으로 배치됨: {1}",
    teks_msg_329: "대각선",
    teks_msg_330: "반대각선",
    teks_msg_331: "상하 대칭",
    teks_msg_332: "좌우 대칭",
